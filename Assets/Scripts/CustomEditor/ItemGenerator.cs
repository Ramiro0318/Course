...
namespace Course.CustomEditor
{
    public class ItemGenerator : EditorWindow
    {
        ...
        private string pathAndName = "Assets/Scripts/CustomEditor/ItemData/New Item.asset";
        

        [MenuItem("Tools/ItemGenerator")]
        static void Init() { 
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button ("Create", _styleButtons)) {
                CreateItem();
                string _itemPathAndName = AssetDatabase.GenerateUniqueAssetPath(pathAndName);
    ...
    //{
    //    EditorGUILayout.LabelField("X: " + base.position.width.ToSting());
